...
if isfile(fullfile('..', 'data', 'RESULTS', 'hyperparameters.dat')) && ...
    ...
    init_alpha= [ 0.001];                    % : the initial learning rates
    init_D= [  1.e-4 ];                          % : the initial distance metrics
    w_gen = [  0.00012 ];  % : weight
    init_lambda = [  0.01 ];                           % : the initial lambda
    final_lambda = [0.99 ];                          % : the final lambda
    tau_lambda = [  0.01 ];                          % : the tau lambda
